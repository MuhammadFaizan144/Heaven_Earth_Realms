    ...
    <section>
      ...
      <article className="w-full bg-zinc-800 py-12 sm:py-16 lg:py-24">
        <div className="mx-auto w-full max-w-6xl px-5 sm:px-8 lg:px-12">
          <div className="max-w-3xl">
            <h2 className="mb-6 text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">
              Play HeavenEarthRealm Now
            </h2>
            <p className="mb-8 text-base leading-7 text-gray-300 sm:text-lg sm:leading-8">
              Join the adventure today and experience the ultimate Minecraft MMORPG Survival experience. Whether you're a seasoned player or new to the world of Minecraft, HeavenEarthRealm offers endless opportunities for exploration, combat, and progression. Don't miss out on this unique gaming experience—start your journey now!
            </p>
            <h3 className="mb-4 text-2xl font-semibold text-white sm:text-3xl">
              How to Join HeavenEarthRealm
            </h3>
